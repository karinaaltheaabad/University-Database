...
Karina, your milestone is returned for the followong reasons: 

1. Database requirements are not completed. You are only doing databases requirements where users are the one creating the action, what about the other ones? Also, database requirements should have requirements for attributes. 

2. You need more strong entities in the entity description. Not all of them are strong

2. Your ERD is not correct, and it needs more work. Lines cannot cross between them, and the relationships you set up are not correct. Please review ERD slides again. 

Fix all of this and re-submit the milestone before by Sunday Jun 14th at midnight. Let me know by email when your milestone is ready. 
